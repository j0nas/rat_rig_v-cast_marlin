...
#define DUAL_X_CARRIAGE
  ...
  #define X2_MIN_POS     6       // Set a minimum to ensure the  second X-carriage can't hit the parked first X-carriage
  #define X2_MAX_POS   350       // Set this to the distance between toolheads when both heads are homed
 ...
 */
  ...
  //#define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    //#define X2_STALL_SENSITIVITY 125
